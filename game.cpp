                    ...
                    if(text.length() == 5 && text[0] == '(' && text[2] == ',' && text[4] == ')'){
                        ...
                        if (isdigit(text[1]) && isdigit(text[3])) {
                            ...
                            if (x >= 0 && x < 6 && y >= 0 && y < 6) {
                                ...
                                const Cell& c_show = matrix_show->getCell(x, y);

                                if (auto v = std::get_if<int>(&c_show.value)) {
                                    std::cout << "Rutan är redan öppnad" << *v << std::endl;
                                    continue;
                                }else{      
                                    ...
                                    std::cout << "Antal öppnade säkra rutor: " << number_of_nonmines_found << "\n";
